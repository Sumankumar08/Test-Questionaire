...
import {questions2} from "../propertyFiles/questions";
...
class Test2 extends Component {
    ...
    handleOptionChange = (changeEvent) => {
        ...
        if (this.state.counter >= questions2.length - 1) {
                ...
                <Container className={classes.container}>
                    ...
                    <div className={classes.questions}>
                        <div className="mainQuestion">
                            ...
                            <h3><strong>{questions2[this.state.counter].id}.</strong> {questions2[this.state.counter].q}</h3>
                        </div>
                        <div className={classes.options}>
                            <label className="option">SELECT ONLY ONE</label>
                            <div className={classes.radio}>
                                <h3>
                                    <label className={classes.opt}>{questions2[this.state.counter].a}
                            ...
                            <div className={classes.radio}>
                                <h3>
                                    <label className={classes.opt}>{questions2[this.state.counter].b}
                            ...
                            <div className={classes.radio}>
                                <h3>
                                    <label className={classes.opt}>{questions2[this.state.counter].c}
                            ...
                            <div className={classes.radio}>
                                <h3>
                                    <label className={classes.opt}>{questions2[this.state.counter].d}
